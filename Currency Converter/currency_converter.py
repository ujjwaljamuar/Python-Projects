...
class CurrencyConverter:                            # Create class
    def __init__(self):                             # Special method in Python class
        ...
        window.configure(bg="lightcoral")                 # Add background color to application window

        # Adding Label widgets to application window
        Label(window, font="Helvetica 12 bold", bg="lightcoral",
        ...
        Entry(window, textvariable=self.conversionRateVar,
              justify=RIGHT).grid(row=2, column=2)

        self.convertedAmountVar = StringVar()
        lblConvertedAmount = Label(window, font="Helvetica 12 bold", bg="lightcoral",
        ...
        btdelete_all = Button(window, text="Clear", font="Helvetica 12 bold", bg="red", fg="white",
